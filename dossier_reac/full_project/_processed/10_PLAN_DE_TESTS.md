...
|--------|-------|-------|----------|
| **Tests unitaires** | Kotest + MockK | Use cases, logique métier | Majorité des tests |
| **Tests d'intégration** | Testcontainers + Ktor TestHost | Repositories SQL, endpoints complets | Scénarios critiques |
...
![Diagramme 8](dossier_reac/full_project/mermaid-images/diagram_8.png)
