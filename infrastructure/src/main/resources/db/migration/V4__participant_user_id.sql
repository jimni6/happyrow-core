...
-- Drop constraint (old schema created it as a constraint, not a plain index)
ALTER TABLE configuration.participant DROP CONSTRAINT IF EXISTS uq_participant_user_event;
